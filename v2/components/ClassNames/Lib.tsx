...
export const classNamesLib = {
  input: 'form-input p-3 rounded w-full focus:outline-none focus:ring-2 focus:ring-purple-700',
  inputDark: 'dark:bg-black border border-gray-300 dark:border-gray-500',
  button: 'font-medium px-4 rounded whitespace-nowrap cursor-pointer',
  ...
  dialogHeader: 'text-xl text-bold text-center',
