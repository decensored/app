...
export const classNamesLib = {
  ...
  navigationAsideInnerBottom: 'pb-4 sm:pb-2',
  ...
  navigationAsideBottomInteractionWrapper: 'flex flex-col flex-col-reverse items-center gap-4 sm:gap-3 sm:justify-between sm:flex-row',
