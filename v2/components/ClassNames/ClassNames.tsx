...
export const classNamesLib = {
  ...
  headerWrapper:
    'sticky top-0 left-0 right-0 bg-gradient w-full flex flex-col items-start z-10',
  headerInner: 'flex w-full gap-y-5 p-4 justify-between items-center',

  inputWrapper: 'relative',
  input:
    'form-input px-3 rounded w-full focus:outline-none border border-gray-300 text-gray-900 focus:ring-1 focus:ring-purple-700 h-[40px]',
  inputDark: 'dark:bg-darkmode-100 dark:border-hidden dark:text-white',

  formValidation:
    'px-[9px] py-1 flex items-center absolute left-[3px] right-[3px] rounded-b bg-opacity-40',
  ...
  dialogInner:
    'relative bg-white w-full max-w-sm mx-auto shadow-xl rounded bg-white divide-y divide-solid divide-gray-200',
  ...
  popoverWrapper:
    'rounded bg-white w-52 divide-y divide-solid divide-gray-200 shadow-xl',
  ...
  popoverBodyButton:
    'rounded flex items-center gap-x-3 text-left p-2 text-sm text-gray-900 hover:text-highlight-900 hover:bg-highlight-100',
  popoverBodyButtonDark:
    'dark:text-gray-500 dark:hover:text-white dark:hover:bg-highlight-900',
  ...
  navigationBottomItem:
    'flex grow flex-col items-center justify-center cursor-pointer text-2xl sm:text-3xl',
  navigationBottomItemColor:
    'text-highlight-900 hover:text-purple-800 dark:text-highlight-500 dark:hover:text-highlight-100',
  ...
  feedItemWrapper:
    'bg-white rounded divide-y divide-solid divide-gray-200 shadow-sm',
  ...
  spaceHeaderColsWrapper:
    'flex w-full mx-auto justify-evenly text-white pt-2 text-center',
