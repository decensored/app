    ...
    <div className="post bg-white dark:bg-gray-900 rounded divide-y divide-solid divide-gray-200 dark:divide-gray-800 shadow-sm">
      <div className="rounded-t p-5">
        <div className="meta flex justify-between">
          <Link href="/user/NameOfUser">
            <a className="author font-bold text-gray-900 dark:text-gray-300">
              Username
            </a>
          </Link>
      ...
      <div className="px-5 py-3 rounded-b flex justify-between">
        <div className="flex gap-x-3 items-center">
          <FontAwesomeIcon
            icon={faShieldAlt}
            className="cursor-pointer text-gray-300 hover:text-gray-900 dark:text-gray-500 dark:hover:text-gray-300 fa-shield-alt"
          />
        </div>
        <div className="flex gap-x-3 items-center">
          <FontAwesomeIcon
